...
if (window.location.pathname == '/') {
  ...
  document.querySelector('#btn-searchInternship').addEventListener('click', function (e) {
    ...
    if (document.querySelector('.alert') == null && city === "" || type === "" || csfr === "") {
      ...
      var div = "<div class=\"alert alert-danger\" role=\"alert\">Please fill in all fields</div>";
      title.insertAdjacentHTML('afterEnd', div);
    } else if (document.querySelector('.alert') != null && city === "" || type === "" === csfr != "") {//if some fields are still not filled in and already displaying error -> do nothing
    } else {
      ...
      fetch('/ajaxSearchInternshipCall', {
        ...
        document.querySelector('.otherInternships').innerHTML = "Internships in other cities"; //delete error message if set by previous form submit
        ...
        otherInternships = JSON.parse(result.otherInternshipsJSON); //set backend data in Vue 

        nearby.internships = nearbyInternships;
        others.internships = otherInternships; //display the titles above vue components on page

        internshipTitles = document.querySelectorAll('.hidden');
        internshipTitles.forEach(function (title) {
